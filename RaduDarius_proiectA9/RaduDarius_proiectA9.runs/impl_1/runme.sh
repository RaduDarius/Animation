...
HD_PWD='C:/Users/Darius Radu/RaduDarius_proiectA9/RaduDarius_proiectA9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reclama_animatie.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reclama_animatie.tcl -notrace
