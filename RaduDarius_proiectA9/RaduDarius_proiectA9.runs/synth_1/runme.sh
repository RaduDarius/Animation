...
HD_PWD='C:/Users/Darius Radu/RaduDarius_proiectA9/RaduDarius_proiectA9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reclama_animatie.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reclama_animatie.tcl
